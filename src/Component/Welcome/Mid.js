...
const Mid = () => {
    return (
        ...
        <div className="px-4 py-4 my-5 text-center">
            ...
            <p className="lead mb-4">Fullstack JavaScript Website adalah sebuah website yang dibuat menggunakan bahasa JavaScript di segala "Stack"-nya. Mulai dari Database, Backend Stack, dan Frontend Stack</p>
            </div>
        </div>
        </section>
    )
